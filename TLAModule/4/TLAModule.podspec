...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/leechuanjun/TLAModule"
  ...
  s.source       = { :git => "https://github.com/leechuanjun/TLAModule.git", :tag => s.version.to_s }
  ...
  s.source_files  = "TLAModule/TLAModule/**/*.{h,m}"
  ...
  s.dependency "TLBModuleCTMediator"

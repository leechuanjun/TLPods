...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is TLAModuleCTMediator
                   DESC

  s.homepage     = "https://github.com/leechuanjun/TLAModuleCTMediator"
  ...
  s.source       = { :git => "https://github.com/leechuanjun/TLAModuleCTMediator.git", :tag => s.version.to_s }
  ...
  s.source_files  = "TLAModuleCTMediator/TLAModuleCTMediator/**/*.{h,m}"
